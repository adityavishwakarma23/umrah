              ...
              <div className="right-accmain">
                <div className="accright-top">
                  <div className="account-para">
                    <Link to="/add-account"> Personal Information </Link>
                  </div>
                ...
                <div className="accright-bottom">
                  <div className="account-email pasch">
                    <label htmlFor="">
                      {" "}
                  ...
                  <div className="need-pas">
                    <p> Need a new Password? </p>
                  </div>
                  <div className="account-email">
                    <label htmlFor="">
                      {" "}
                      New Passwordem <em>*</em>
                    </label>
                    <input
                      type="password"
                      name=""
                  ...
                  <div className=" accsaveneed">
                    <Link to="" className="cnfrm-btn">
                      {" "}
                      Update Password{" "}
                    </Link>
                  </div>
