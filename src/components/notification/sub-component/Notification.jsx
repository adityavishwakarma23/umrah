                ...
                <div className="card account-main">
                  <div className="inner-flax-left">
                   ...
                   <div className="innerbotam-main">
                                   ...
                                   <div className="wedmango-main notify">
                                     <div className="wedero">
                                       <span>
                                         <svg
                                           width="18"
                  ...
                  <div className="inner-flax-right">
                   <div className="notifict-hed">
                    <h1> Notifications </h1>
                   </div>
                   <div className="notifiction-main">
                      <div className="notifi-cuntmain">
                        <div className="notifi-cunt">
                          <div className="notifi-cunthed">
                          <h1> Booking Confirmation</h1>
                          </div>
                          <div className="notifinew">
                            <span>
                        ...
                        <div className="notificati-cuntp">
                        <p> Your Umrah package has been successfully booked!
