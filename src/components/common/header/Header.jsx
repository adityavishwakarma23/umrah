...
const Header = ({checkClass}) => {
  ...
  return (
    <header className={checkClass ? "home-header" : ""}>
              ...
              <ul>
                ...
                <li>
                  <div className="hdrbtnh btnh">
                    <Link to="/packagemain" className={isActive("/packagemain") ? "active" : ""}> Packages </Link>
                  </div>
                </li>
              </ul>
            </div>
                  ...
                  <div className="card dropdown-mango">
                    <div className="wedmango-main">
                      <div className="wedmango ">
                        <Link to="" className={location.pathname === "/my-account" ? "active" : ""}>
                        <span>
                          <svg
                            width="18"
                            height="17"
                    ...
                    <div className="wedmango-main">
                      <div className="wedmango">
                        <Link to="" onClick={handleLogoutPopup}>
                        <span>
                          <svg
                            width="18"
                            height="18"
