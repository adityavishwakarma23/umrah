...
import { Compearimg, Download } from "../../../assets/images";
import {Link} from 'react-router-dom'

const PackagePopUp = () => {
  return (
    <div className="card compare-popup">
      <div className="compare-pop-inner">
        <div className="compare-pop-heading">
          <h3> Compare package </h3>
        </div>
        <div className="compare-pkglist">
          <ul>
            <li>
              <div className="compare-card">
                <div className="compard-bg">
                  <span>
                    <img src={Compearimg} alt="" />
                  </span>
                  <div class="remove-compare">
                    <em>
                      ...
                      >
                        <path
                          d="M9.66683 1.2735L8.72683 0.333496L5.00016 4.06016L1.2735 0.333496L0.333496 1.2735L4.06016 5.00016L0.333496 8.72683L1.2735 9.66683L5.00016 5.94016L8.72683 9.66683L9.66683 8.72683L5.94016 5.00016L9.66683 1.2735Z"
                          fill="white"
                        ></path>
                      </svg>
                    </em>
                ...
                <div class="compard-details">
                  <h3>EXECUTIVE Umrah Packages</h3>
                  <div class="comprdtls-flex">
                    <div class="comprdtls-wthicon">
                      <span>
                        <svg
                          width="13"
                          height="18"
                        ...
                        >
                          <path
                            opacity="0.3"
                            d="M2 9.00016C2 5.32516 4.99167 2.3335 8.66667 2.3335C8.95 2.3335 9.23333 2.35016 9.50833 2.39183C7.91667 4.19183 7 6.54183 7 9.00016C7 11.4585 7.91667 13.8085 9.50833 15.6085C9.23333 15.6502 8.95 15.6668 8.66667 15.6668C4.99167 15.6668 2 12.6752 2 9.00016Z"
                            fill="#D4AF37"
                          ></path>
                          <path
        ...
        <div class="compare-actions">
          <div class="compare-actions-inner">
            <button class="btn btn-secondary" fdprocessedid="yjzvp5">
              Remove All
            </button>
          </div>
          <div class="compare-actions-inner">
            <div class="shimmer-button">
              <img src={Download} alt="Umrah" class="shimmer-image" />
              <Link to='/add-package' class="btn btn-primary" href="">
                Compare
              </Link>
            </div>
          </div>
