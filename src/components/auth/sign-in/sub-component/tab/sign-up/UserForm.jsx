...
const UserForm = () => {
  ...
  // firstName, lastName, emial, passowrd, confirmpassword
  ...
  const handleUserSubmit =  async (e) => {
    ...
    try {
      ...
      //   return new Error("Password and Confirm Password doesn't match!");
      // }

      console.log("Inside Handle User Submit", userFormData);
              ...
              <div className="form-flex">
                ...
                <div className="form-inner-flx-100">
                  <div className="form-inputs">
                    ...
                    <div className="input-wthicon">
                      <input type="password" onChange={handleUserChange} id="password" placeholder="Enter Your Password" />
                ...
                <div className="form-inner-flx-100">
                  <div className="form-inputs">
                    ...
                    <div className="input-wthicon">
                      <input type="password" onChange={handleUserChange} id="confirmPassword" placeholder="Enter Your Password" />
                      <div className="input-icon">
                        <span>
                          <i className="fa-regular fa-eye"></i>
                        </span>
